...
class CfnModuleVersion(
    ...
    def module_package(self) -> typing.Optional[builtins.str]:
        ...
        '''
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "modulePackage"))
...
class CfnStackSet(
    ...
    def auto_deployment(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnStackSet.AutoDeploymentProperty", aws_cdk.core.IResolvable]], jsii.get(self, "autoDeployment"))
...
class CfnStackSetProps:
    ...
    def auto_deployment(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnStackSet.AutoDeploymentProperty, aws_cdk.core.IResolvable]], result)
